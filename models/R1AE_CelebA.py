...
class ConvLRAE(nn.Module):
    def __init__(self, in_features,out_features, n_bins, grid,
        ...
        self.up = nn.Sequential(
                                ...
                                UpsampleBlock(in_features=128, out_features=in_channels,  nonlinearity=nn.Sigmoid()),
                                )
...
class ConvVAE(nn.Module):
    def __init__(self, in_features, out_features, nonlinearity, in_channels=3, start_dropout=0 ):
        super().__init__()
...
class ConvAE(nn.Module):
    def __init__(self, in_features, out_features, nonlinearity, in_channels=3, start_dropout=0):
        ...
        self.up = nn.Sequential(
                                ...
                                UpsampleBlock(in_features=512, out_features=256, nonlinearity=nonlinearity),
                                UpsampleBlock(in_features=256, out_features=128, nonlinearity=nonlinearity),
                                UpsampleBlock(in_features=128, out_features=in_channels,  nonlinearity=nn.Tanh()),
                                )
