...
# {
# nohup python3 run_train.py -m VAE -a NIPS -D MNIST -d cuda:0 -A 0.01
# nohup python3 run_train.py -m VAE -a NIPS -D MNIST -d cuda:0 -A 0.001
# nohup python3 run_train.py -m VAE -a NIPS -D MNIST -d cuda:0 -A 0.0001  
# } > $test_dir_name/o_MNIST_VAE.out 2>&1  &

{
nohup python3 run_train.py -m LRAE -a NIPS -D MNIST -d cuda:1 -A 0.01
nohup python3 run_train.py -m LRAE -a NIPS -D MNIST -d cuda:1 -A 0.001
