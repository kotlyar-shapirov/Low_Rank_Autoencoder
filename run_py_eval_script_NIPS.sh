...
nohup python3 run_eval.py -l test_NIPS/test_o_NIPS__MNIST__LRAE__128__0.5__50.pth -o eval_NIPS/data_o -d cuda:2 -a NIPS > $eval_dir_name/o_LRAE_0.5_e50.out 2>&1 &
